...
// // zad6
// // Konwerter miar czasu: Napisz program w c#, który przelicza czas między różnymi jednostkami (godziny, minuty).

// int godziny = int.Parse(Console.ReadLine());
// int minuty = godziny * 60;

// Console.WriteLine("Minuty = {0}", minuty);
 
// // zad7
// // Konwerter miar masy: Napisz program w c#, która przelicza jednostki masy, takie jak gramy, kilogramy, tony.

// double gramy = double.Parse(Console.ReadLine());
// double kilogramy = gramy / 1000;
// double tony = gramy / 1000000;

// Console.WriteLine("Kilogramy = {0}", kilogramy);
// Console.WriteLine("Tony = {0}", tony);
